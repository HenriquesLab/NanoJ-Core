package nanoj.core.java.io.zip.virtualStacks;
...
public class FramesFromBlocksVirtualStack extends BaseVirtualStack {
    ...
    private nanoj.core.java.io.zip.imageInBlocks.OpenImageFromBlocksInZip openImageFromBlocksInZip;

    public FramesFromBlocksVirtualStack(String title, nanoj.core.java.io.zip.imageInBlocks.OpenImageFromBlocksInZip openImageFromBlocksInZip) throws IOException {

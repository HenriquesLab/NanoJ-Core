...
import nanoj.core.java.io.zip.filesInZipTypes.TiffFileInZip;
import nanoj.core.java.io.zip.virtualStacks.FramesFromBlocksVirtualStack;
...
public class OpenImageFromBlocksInZip {
    ...
    nanoj.core.java.io.zip.ParseFileNamesInZip pzf;

    public OpenImageFromBlocksInZip(String filePath) throws IOException {
        pzf = new nanoj.core.java.io.zip.ParseFileNamesInZip(filePath);
        pattern = pzf.pattern;
        parseBlockSize();
        parseDimensions();
    }
    ...
    public nanoj.core.java.io.zip.virtualStacks.BlocksVirtualStack getTBlockVirtualStack(int zBlock, int xBlock, int yBlock, boolean withMargins) {
        ...
        return new nanoj.core.java.io.zip.virtualStacks.BlocksVirtualStack(pattern, blocks, r, withMargins);
    }
